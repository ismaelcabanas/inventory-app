...
public class DefaultDomainEventPublisherShould {
    ...
    private void subscribe(DomainEventSubscriber subscriber) {
        DefaultDomainEventPublisher.getInstance().subscribe(subscriber);
    }

    private void publish(DomainEvent domainEvent) {
        DefaultDomainEventPublisher.getInstance().publish(domainEvent);
    }

    private void unsubscribe(DomainEventSubscriber subscriber) {
        DefaultDomainEventPublisher.getInstance().unsubscribe(subscriber);
    }
